...
impl Rasterizer {
    ...
    */
    ...
    fn scan_edges(&mut self, blitter: &mut dyn RasterBlitter, winding_mode: FillRule) {
        let mut edge = self.active_edges;
    ...
    pub fn rasterize(&mut self, blitter: &mut dyn RasterBlitter, winding_mode: FillRule) {
    ...
    pub fn get_bounds(&self) -> Box2D<i32> {
        Box2D::new(
            point(
    ...
    pub fn set_winding(&mut self, winding: i32) {
