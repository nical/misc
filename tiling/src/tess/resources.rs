use crate::{gpu::{Shaders, shader::{ShaderGeometryId, GeometryDescriptor, VertexAtribute, OutputType, BlendMode, PipelineDescriptor, GeneratedPipelineId, ShaderMaskId}}, canvas::{RendererResources}};
...
impl MeshGpuResources {
    pub fn new(
        ...
        let simple_mesh_geometry = shaders.register_geometry(GeometryDescriptor {
            ...
            source: include_str!("../../shaders/renderers/geometry/simple_mesh.wgsl").into(),
