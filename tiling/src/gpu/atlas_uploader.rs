use wgpu::{BufferAddress, BindGroupEntry};
...
impl TileAtlasUploader {
    ...
    fn allocate_staging_buffer(&mut self, device: &wgpu::Device) {
        ...
        let size = self.staging_buffer_size as BufferAddress;
...
impl MaskUploadCopies {
    ...
    pub fn update_target(
        ...
        for batch in &uploader.batches {
            ...
            let offset = batch.staging_range.start as BufferAddress;
            let copy_size = batch.staging_range.end as BufferAddress - offset;
