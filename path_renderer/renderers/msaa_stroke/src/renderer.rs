use core::{
    ...
    }, pattern::BuiltPattern, render_pass::{BuiltRenderPass, RenderCommandId}, render_task::RenderTaskAdress, shape::FilledPath, transform::Transform, units::LocalRect, wgpu
};
