...
pub use instance::{Instance, Frame};
...
pub mod units {
    ...
    pub type SurfaceIntVector = Vector2D<i32, SurfaceSpace>;
...
impl BindingsNamespace {
    ...
    fn next(&self) -> Self {
        ...
        BindingsNamespace(self.0 + 1)
    }

    #[doc(hidden)]
    pub fn testing(idx: u8) -> Self {
...
impl BindingsId {
    ...
    // aggressively.
    #[inline]
    pub const fn new(namespace: BindingsNamespace, index: u16) -> Self {
    ...
    #[inline]
    pub fn to_u32(self) -> u32 {
        (self.namespace.0 as u32) << 16 | self.index as u32
    }
}
...
pub trait BindingResolver {
    ...
    fn resolve_texture(&self, id: BindingsId) -> Option<&wgpu::Texture>;
}
...
impl BindingResolver for () {
    ...
    fn resolve_texture(&self, _: BindingsId) -> Option<&wgpu::Texture> { None }
}
